...
from services.ai_prediction_lab.current_career_timing_context import build_current_career_timing_context
from services.ai_prediction_lab.current_career_timing_prompt_builder import build_current_career_timing_prompt
...
class CareerGenerator(BaseAIGenerator):
    ...
    _PROMPT_VERSIONS = {
        ...
        # above are unchanged.
        "CURRENT_TIMING": "current_career_timing_v1",
    }
    ...
    def build_context(
        ...
        *,
        ...
        if report_type == "CURRENT_TIMING":
            ...
            timing_context = build_current_career_timing_context(kundali)  # existing Lab context builder
            return {
                "current_career_phase": current_career_phase_text,
    ...
    def build_prompt(
        ...
        *,
        ...
        if report_type == "CURRENT_TIMING":
            return build_current_career_timing_prompt(
                current_career_phase=context["current_career_phase"],
