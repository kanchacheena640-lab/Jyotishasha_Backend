# services/ai_prediction_lab/current_health_timing_prompt_builder.py

"""
services/ai_prediction_lab/current_health_timing_prompt_builder.py
--------------------------------------------------------------------
Loads prompts/current_health_timing_v1.txt and fills it with the
Current Health Timing context (current_health_timing_context.py) plus
the already-generated Current Health Phase text (the report this layer
...
_CURRENT_HEALTH_TIMING_TEMPLATE = os.path.join(_TEMPLATE_DIR, "current_health_timing_v1.txt")

_TIMING_PLANETS = ["moon", "sun", "mars"]
...
def build_current_health_timing_prompt(
    current_health_phase: str,
    context: Dict[str, Any],
    language: str = "en",
) -> str:
    template = _load_template(_CURRENT_HEALTH_TIMING_TEMPLATE)

    values: Dict[str, str] = {
        "current_phase_text": current_health_phase,
