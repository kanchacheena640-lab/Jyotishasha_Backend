# services/ai_prediction_lab/current_family_timing_prompt_builder.py

"""
services/ai_prediction_lab/current_family_timing_prompt_builder.py
--------------------------------------------------------------------
Loads prompts/current_family_timing_v1.txt and fills it with the
Current Family Timing context (current_family_timing_context.py) plus
the already-generated Current Family Phase text (the report this layer
...
_CURRENT_FAMILY_TIMING_TEMPLATE = os.path.join(_TEMPLATE_DIR, "current_family_timing_v1.txt")

_TIMING_PLANETS = ["moon", "venus"]
...
def build_current_family_timing_prompt(
    current_family_phase: str,
    context: Dict[str, Any],
    language: str = "en",
) -> str:
    template = _load_template(_CURRENT_FAMILY_TIMING_TEMPLATE)

    values: Dict[str, str] = {
        "current_phase_text": current_family_phase,
